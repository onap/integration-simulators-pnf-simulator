...
Simulator can cooperate with VES server in different security types in particular ```auth.method=certOnly``` which means that it needs to authenticate using client private certificate. 
