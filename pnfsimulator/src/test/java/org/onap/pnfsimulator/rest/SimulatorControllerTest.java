...
class SimulatorControllerTest {
    ...
    @Test
    void shouldTestControllerWork() throws Exception {
        String contentAsString = mockMvc
    ...
    @Test
    void shouldSuccessfullyCancelJobThenReturnsProperMessage() throws Exception {
    ...
    @Test
    void shouldTryToCancelJobButNotBeingAbleToFinishThenReturnProperMessage() throws Exception {
    ...
    @Test
    void whenSendingJobNameWithBreakingCharactersShouldSuccessfullyCancelJobThenReturnProperMessage() throws SchedulerException {
